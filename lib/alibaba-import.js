...
function buildBlockedPageDraft(sourceUrl) {
  ...
  return {
    ...
    images: [],
    seoTitle: trimTo(`${name} | ANRIVERS RF Control`, 60),
    seoDescription: trimTo(`${name}. Contact ANRIVERS RF Control for product specifications and customization options.`, 155),
    sourceUrl: sourceUrl.toString(),
    warnings,
  };
}
